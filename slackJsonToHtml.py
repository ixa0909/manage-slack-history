...
dayEnd = date(2022,9,1)

# dayStart = date(2018,11,1)
# dayEnd = date(2018,11,2)
        ...
        for j in range(len(fLoad)):
            ...
            try:
                ...
                if datas["username"]=="Trello":
                    fCh.write("<br>"+datas["attachments"][0]["fallback"]+"<br>")
